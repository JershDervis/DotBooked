...
internal static class Guard
{
    internal static class Against
    {
        ...
        public static void ZeroOrPositive(decimal value, [CallerArgumentExpression(nameof(value))] string? paramName = null)
        {
            if (value >= 0)
                throw new ZeroOrNegativeDomainException($"{paramName} cannot be zero or positive");
        }
